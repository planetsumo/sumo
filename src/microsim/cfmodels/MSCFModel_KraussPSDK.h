/****************************************************************************/
/// @file    MSCFModel_KraussPSDK.h
/// @author  Tobias Mayer
/// @author  Daniel Krajzewicz
/// @author  Jakob Erdmann
/// @author  Michael Behrisch
/// @date    Tue, 28 Jul 2009
/// @version $Id: MSCFModel_KraussPSDK.h 15931 2014-03-13 16:45:46Z dkrajzew $
///
...
//
/****************************************************************************/
#ifndef MSCFModel_KraussPSDK_h
#define	MSCFModel_KraussPSDK_h
...
public:
     ...
     */
    MSCFModel_KraussPSDK(const MSVehicleType* vtype, SUMOReal accel, SUMOReal decel, SUMOReal dawdle, SUMOReal headwayTime);


    /// @brief Destructor
    ~MSCFModel_KraussPSDK();
    ...
    int getModelID() const {
        return SUMO_TAG_CF_KRAUSS_PLUS_SLOPE_DK;
    }
    /// @}
