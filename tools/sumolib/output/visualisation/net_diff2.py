...
#colorMap = parseColorMap("0:#00ff00,.499:#00ff00,.5:#c0c0c0,.501:#ff0000,1:#ff0000")
colorMap = parseColorMap("0:#00ff00,.5:#c0c0c0,1:#ff0000")
print "reading net"
...
edgeMaxValuesC = 50000000.
print log(edgeMaxValuesC)
edgeMinValuesC = -50000000.
