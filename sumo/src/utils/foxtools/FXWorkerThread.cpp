...
// Message map
FXDEFMAP(FXWorkerThread) FXWorkerThreadMap[] = {
    FXMAPFUNC(SEL_IO_READ, FXWorkerThread::ID_THREAD_EVENT, FXWorkerThread::onThreadSignal),
    FXMAPFUNC(SEL_THREAD, 0, FXWorkerThread::onThreadEvent),
};
FXIMPLEMENT(FXWorkerThread, FXObject, FXWorkerThreadMap, ARRAYNUMBER(FXWorkerThreadMap))



FXWorkerThread::FXWorkerThread(FXApp* a, MFXInterThreadEventClient* client)
...
void
FXWorkerThread::signal(FXuint seltype) {
...
long
FXWorkerThread::onThreadSignal(FXObject*, FXSelector, void*) {
#ifndef WIN32
    FXuint seltype = SEL_THREAD;
...
long
FXWorkerThread::onThreadEvent(FXObject*, FXSelector , void*) {
